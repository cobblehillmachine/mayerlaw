...
function create_post_type() {
  ...
  register_post_type( 'tri_about', $args1);
  register_post_type( 'tri_contact', $args2);
  
  
	register_taxonomy_for_object_type('post_tag', 'tri_contact');
	register_taxonomy_for_object_type('post_tag', 'tri_about');
	
	register_taxonomy_for_object_type('category', 'tri_contact');
	register_taxonomy_for_object_type('category', 'tri_about');
